export default function Footer() {
  ...
  return (
    <footer className="bg-blue-950 text-blue-100 pb-20 pt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-10 border-b border-blue-800">
          {/* Brand */}
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <span className="block text-[10px] text-blue-400 font-medium tracking-widest uppercase -mt-1">Vet Clinic</span>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-4">
              {["facebook", "instagram", "twitter", "whatsapp"].map((s) => (
                <a key={s} href="#" aria-label={s} className="w-8 h-8 rounded-full bg-blue-800 hover:bg-blue-600 flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item}>
                  <a href="#services" className="text-blue-300 hover:text-white text-sm transition-colors">
                    {item}
                  </a>
                </li>
              ))}
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-blue-400">
