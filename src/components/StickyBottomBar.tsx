  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-green-700 shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6">
        ...
        <a
          href="tel:9958436981"
          className="inline-flex items-center gap-2 bg-white text-green-800 font-bold text-sm sm:text-base px-6 py-2 rounded-full hover:bg-blue-50 transition-colors shadow-md whitespace-nowrap"
        >
