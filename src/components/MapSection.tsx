    ...
    <section id="location" className="py-20 bg-white scroll-mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-red-900 mb-4">Our Location</h2>
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-red-50 rounded-2xl p-5 border border-red-100">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-xl bg-red-700 flex items-center justify-center shrink-0">
                ...
                <div>
                  <h3 className="font-bold text-red-900 mb-1">Address</h3>
            ...
            <div className="bg-red-50 rounded-2xl p-5 border border-red-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-red-900 mb-1">Opening Hours</h3>
                  <div className="text-sm text-slate-600 space-y-1">
                    ...
                    <div className="mt-2 pt-2 border-t border-red-100">
                      <span className="text-red-700 font-semibold">Emergency: 24/7</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-red-50 rounded-2xl p-5 border border-red-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-red-900 mb-1">Contact</h3>
                  <a href="tel:9958436981" className="text-red-700 font-semibold text-sm hover:underline block">
                    +91 99584 36981
                  </a>
                  <a href="mailto:info@pawcarevetclinic.com" className="text-slate-600 text-sm hover:text-red-700 transition-colors block mt-0.5">
        ...
        <div className="mt-6 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-red-700 hover:bg-red-800 text-white font-semibold px-6 py-3 rounded-full transition-colors shadow-md hover:shadow-lg"
          >
